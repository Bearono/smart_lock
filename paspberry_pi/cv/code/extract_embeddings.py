...
_DEFAULT_OUTPUT_DIR = os.path.join(_PROJECT_ROOT, "data", "templates")
_DEFAULT_EMB_INDEX = os.path.join(_PROJECT_ROOT, "data", "templates", "emb_index.csv")
_DEFAULT_MANIFEST = os.path.join(_PROJECT_ROOT, "data", "templates", "manifest_enroll.csv")
...
def extract_embeddings_batch(
    manifest_enroll_path: str = None,
    output_base_dir: str = None,
    emb_index_path: str = None,
    margin_ratio: float = 0.2,
) -> Dict[str, int]:
    if manifest_enroll_path is None:
        manifest_enroll_path = _DEFAULT_MANIFEST
    if output_base_dir is None:
        output_base_dir = _DEFAULT_OUTPUT_DIR
    if emb_index_path is None:
        emb_index_path = _DEFAULT_EMB_INDEX
    """
    批量提取 embedding
