...
def create_templates_batch(
    embs_base_dir: str = None,
    templates_output_dir: str = None,
    method: Literal["mean", "median", "weighted_mean"] = "mean",
    use_normalized: bool = True,
) -> Dict[str, any]:
    if embs_base_dir is None:
        embs_base_dir = _DEFAULT_EMBS_DIR
    if templates_output_dir is None:
        templates_output_dir = _DEFAULT_TEMPLATES_DIR
    """
    批量为所有用户创建聚合模板
